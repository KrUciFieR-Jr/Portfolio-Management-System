...
public class Strategy {
   ...
   *         This will be used when the strategy execution failed due to price unavailability. Next
   *         time when program is loaded it will retry the strategy from the date in this particular
   *         field.
